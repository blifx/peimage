...
function enviaEmail($nomeDestinario, $emailDestinatario, $assunto, $texto, $saudacao = ''){
    ...
    if($saudacao == ''){
        $saudacao = "Olá $nomeDestinario, seja bem vindo ao Peimage!";
    }

    $from = "Equipe Peimage<equipe@peimage.com.br>";
    $to = $emailDestinatario;
    $subject = '=?UTF-8?B?'.base64_encode($subject).'?=';
    

    $body =  '<html><body>';
    $body .= '<div style="color:#006064; font-size:20px">'.$saudacao.'</div>';
    $body .= '<p>'.$texto.'</p>';
    $body .= '<div>Atenciosamente,</div>';
    $body .= '<div>Equipe Peimage.</div><br/>';
    $body .= '<div style="max-width:150px"><a href="https://peimage.com.br" ><img src="https://peimage.com.br/wp-content/uploads/2019/06/peimage.png" style="max-width:150px"></a></div>';
    $body .= '</body></html>';

    $host = "mail.peimage.com.br";
    $username = "equipe";
    $password = "*&#hd{hK-02js63lp+9!;<]";
	...
	function menu($logo, $imageMenu){
		...
		<ul>
			<li class="active has-sub"><img  src="'.$imageMenu.'" alt="logo"  width="23" height="22"/>
			  <ul>';
		if($email == 'peimage@peimage.com.br'){
			echo '
				...
				<li class="has-sub"><a href="' . $__HTTP_HOST . '/src/actionRedeSocial.php"><span>Redes sociais</span></a></li>
