...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    if($promocao == 'on'){
        ...
        $horizontalPreco=centerText(165, 18, $fontBold, "POR R$ ".$preco);

        imagecopymerge($imgTheme, $image, 0, 0, 0, 0, 540, 960, 100);  
        //imagecopymerge($imgTheme, $imgThemeType, 20, 20, 0, 0, 298, 362, 100);
        imagecopyresampled($imgTheme, $imgThemeType, 20, 50, 0, 0, 126, 180, 126, 180);

        imagecopymerge($imgTheme, $anuncioBoard, $pos_x+333, $pos_y+668, 0, 0, 169, 119, 100);   
        imagecopymerge($imgTheme, $anuncio, $pos_x+335, $pos_y+670, 0, 0, 165, 115, 100); 
        ...
        imagettftext($imgTheme, 18, 0,$pos_x+335+$horizontalPreco, $pos_y+767, $vermelho, $fontBold, "POR R$ ".$preco);
