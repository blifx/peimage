...
/*     
    ...
    $red = imagecolorallocate($imgTheme, 205, 52, 56);
    ...
    switch ($positionText) {
        case "direita":
            include 'controllersPositionsStories/textRight.php';
            break;
        case "esquerda":
            include 'controllersPositionsStories/textLeft.php';
            break;
        case "acima":
            include 'controllersPositionsStories/textAbove.php';
            break;
        case "abaixo":
            include 'controllersPositionsStories/textBelow.php';
            break;
    }
    ...
    if ($observacao != "") {
        ...
        ImageFilledRectangle($imgTheme, 10, 1250, $obsText_+20, 1268, $whiteObs); 
        imagettftext($imgTheme, 14, 0, $obsText, 1265, $black, $font, $observacao);
    } 
