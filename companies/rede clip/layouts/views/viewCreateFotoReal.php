...
if(!empty($_GET['layout'])){
    ...
    if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
        $typeThemes = preg_replace('/[ ]+/' , '%20' , $layout);
        $typeThemes = preg_replace('/[|]+/' , '_' , $layout);
        $layout = $typeThemes;
    } else {
        $typeThemes = $layout;
    }
    ...
    //$dirThemes = '../campaigns/'.$idcampaign.'/foto%20real%20-%20status%20_%20stories/';
...
<script type="text/javascript">
    ...
    function submitFormView(){
        ...
        if($("#titulo").val() == "" || $("#sub").val() == "" ||$("#desc").val() == "" || $("#preco").val() == "" ){
