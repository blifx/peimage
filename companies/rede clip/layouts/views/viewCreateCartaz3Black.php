...
?>
    ...
    <html lang="pt-br" >
        <head>
            ...
            <title>Peimage - Cartaz 3 preços </title>
        ...
        <body>
            ...
            <div id="content">
                ...
                <form id="waterform" method="post" action="actionCreateCartaz3Black.php" enctype="multipart/form-data" target="_blank">
                    <label id="name">Texto 1*</label>
                    <input type="text" id="name" name="texto1" required="required" /><br/> 
                    <label id="name">Texto 2*</label>
                    <input type="text" id="name" name="texto2" required="required" /><br/> 
                    <label id="name">Texto 3*</label>
                    <input type="text" id="name" name="texto3" required="required" /><br/> 
                    ...
                    <div id="img_theme">
                        <img src="<?php echo $dirThemes.$primaryTheme; ?>" width="175" height="247"/>
                    </div>
                    <label>Produto*</label>
                    ...
                    <input type="text" placeholder="ex: 99,90" id="name" name="promo" required="required" value="" />
                    <label>Outlet</label>
                    <input type="text" placeholder="ex: 99,90" id="name" name="outlet" required="required" value="" />
