    ...
    <html lang="pt-br" >
        ...
        <body>
            ...
            <div id="content">
                ...
                <form id="waterform" method="post" action="actionCreatePost.php" enctype="multipart/form-data" target="_blank">
                    ...
                    <div id="img_theme">
                        ...
                        <img src="<?php echo $dirThemes.$primaryTheme; ?>" width="175" height="175"/>
                    ...
                    <select id="tema" name="positionText" required="required">
                        ...
                        <option value="direita">Horizontal</option>

                        <option value="acima">Vertical</option>
                    ...
                    <input type="number" id="dinheiro" name="promo" step="0.01" pattern="^\d+(\.\d{1,2})?$" placeholder="0,00" required>
