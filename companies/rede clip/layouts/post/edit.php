<form id="form-layout">
    ...
    <label>Tamanha da imagem</label>
    <input type="range" id="f-height-img" value="0" min="0" max="200">

    <label>Movimento Horizontal</label>
    <input type="range" id="f-height-conteudo" value="0" min="0" max="200">

    <label>Movimento Vertical</label>
    <input type="range" id="f-left-right-conteudo" value="0" min="0" max="320">
    ...
    <input type="text" id="f-precif" placeholder="Digite a precificação do produto" maxlength="10" /> 
