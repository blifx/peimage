...
function setConfLayout(confLayout){
    ...
    if(getParamURL("campanha") == "44"){
        $("#price-desc").css({
            ...
            "left": "461px",
            "font-weight": "bold",
            "background-image": "url("+__HTTP_HOST+"src/layouts/layout1/img/desconto_natal.jpg)",
    ...
    if(getParamURL("campanha") == "57"){
        $("#price-desc").css({
            ...
            "left": "461px",
            "font-weight": "bold",
            "background-image": "url("+__HTTP_HOST+"src/layouts/layout1/img/desconto_volta_aulas.png)",
            "background-repeat": "no-repeat"
        });
    ...
    if(getParamURL("campanha") == "62"){
        $("#price-desc").css({
            ...
            "left": "461px",
            "font-weight": "bold",
            "background-image": "url("+__HTTP_HOST+"src/layouts/layout1/img/desconto_torra_brinquedos.png)",
            "background-repeat": "no-repeat"
        });
    ...
    if(getParamURL("campanha") == "64"){
        $("#price-desc").css({
            ...
            "left": "461px",
            "font-weight": "bold",
            "background-image": "url("+__HTTP_HOST+"src/layouts/layout1/img/desconto_pascoa.png)",
            "background-repeat": "no-repeat"
        });
