//SimpleMaskMoney
//https://www.cssscript.com/demo/money-mask-library-vanilla-javascript/
this.SimpleMaskMoney = (() => {
  ...
  return {
    ...
    removeSeparator: (value, separator) => {
          return separator != "" ? value.replace(new RegExp(`\\${separator}`, 'g'), '') : value;
    },
    ...
    setMask: (element, args) => {
      ...
      input.addEventListener('focusout', () => {
        if(this.SimpleMaskMoney.args.allowEmpty 
