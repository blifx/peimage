...
$centerVerticalCabecalho=centerImage(220,$centerVerticalCabecalho[5]);
    ...
    $horizontalPromo=centerText(595, 100, $fontBold, $promo);
        ...
        case "com imagem":
            switch ($promocao) 
            {
                case "on":
                    ...
                    imagettftext($imgTheme, 24, 0, 15, 600, $colorDe, $font, "De");
                    imagettftext($imgTheme, 60, 0, $horizontalPreco, 605, $colorPreco, $fontBold, 'R$'.$preco);
                    imagettftext($imgTheme, 24, 0, 15, 684, $colorPor, $font, "Por");
                    imagettftext($imgTheme, 24, 0, 15, 715, $colorRsPor, $font, "R$");
                    imagettftext($imgTheme, 100, 0, $horizontalPromo, 790, $colorPromo, $fontBold, $promo);
                    imagecopymerge($imgTheme, $imgLine, $centerLine, 580, 0, 0, $constLineWidth, $constLineHeight, 100);
                    ...
                    imagearc( $imgTheme, $horizontalDesc+389, $verticalDesc+288, 120, 120, 0, 360, $white );
                    imagefill( $imgTheme, $horizontalDesc+389, $verticalDesc+288, $red );
                    imagettftext($imgTheme, 45, 0, $horizontalDesc+355, $verticalDesc+320, $colorText_empresa, $fontBold, $porcentagem);
                    imagettftext($imgTheme, 20, 0, $horizontalDesc+417, $verticalDesc+305, $colorText_empresa, $fontBold, "%");
                    imagettftext($imgTheme, 22, 0, $horizontalDesc+357, $verticalDesc+273, $colorText_empresa, $fontBold, "Desc.");
                break;
                case "off":
                    imagecopymerge($imgTheme, $imgProduct, $horizontalProduct, 210+$centerVerticalImagePromo, 0, 0, $width, $height, 100);
                    imagettftext($imgTheme, 24, 0, $horizontalTitulo, 565, $colorText, $fontBold, $titulo);
                    imagettftext($imgTheme, 20, 0, $horizontalDescricao, 595, $colorText, $font, $desc); 
                    imagettftext($imgTheme, 24, 0, 15, 684, $colorPor, $font, "Por");
                    imagettftext($imgTheme, 100, 0, $centerPreco, 790, $colorPromo, $fontBold, $preco);
                    imagettftext($imgTheme, 24, 0, 15, 715, $colorRsPor, $font, "R$");
                    $widthPreco = imagettfbbox ( 100, 0, $fontBold, $preco );
                    imagettftext($imgTheme, 16, 0, $horizontalPreco_+($widthPreco[2]), 800, $colorRsPor, $font, 'cada'); 
                break;
            }
        break;
        case 'sem imagem':
            switch ($promocao) {
                case "on":
                    ...
                    /*Insere o preço e a promoção*/
                    imagettftext($imgTheme, 24, 0, 15, 600, $colorDe, $font, "De");
                    imagettftext($imgTheme, 60, 0, $horizontalPreco, 605, $colorPreco, $font, 'R$'.$preco);
                    imagettftext($imgTheme, 24, 0, 15, 684, $colorPor, $font, "Por");
                    imagettftext($imgTheme, 24, 0, 15, 715, $colorRsPor, $font, "R$");
                    imagettftext($imgTheme, 100, 0, $horizontalPromo, 790, $colorPromo, $fontBold, $promo);
                    imagecopymerge($imgTheme, $imgLine, $centerLine, 580, 0, 0, $constLineWidth, $constLineHeight, 100);
                ...
                break;
                case "off":
                    imagettftext($imgTheme, 30, 0, $centerTitulo, 420, $colorText, $fontBold, $titulo);
                    imagettftext($imgTheme, 24, 0, $centerDescricao, 465, $colorText, $font, $desc);
                    imagettftext($imgTheme, 100, 0, $centerPreco, 790, $colorPromo, $fontBold, $preco);
                    imagettftext($imgTheme, 24, 0, 15, 684, $colorPor, $font, "Por");
                    imagettftext($imgTheme, 24, 0, 15, 715, $colorRsPor, $font, "R$");
                    $widthPreco = imagettfbbox ( 100, 0, $fontBold, $preco );
