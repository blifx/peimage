...
$z=25;
    ...
    switch ($promocao) 
    {
        case "on":    
            ...
            imagettftext($imgPhoto, $tamanhoFontTexto, 0, 105+$x_anuncio-10-20+$move_x, 435+$y_anuncio+$move_y+$z, $black, $fontBold, $titulo);
            imagettftext($imgPhoto, $tamanhoFontTexto, 0, 105+$x_anuncio-10-20+$move_x, 473+$y_anuncio+$move_y+$z, $black, $font, $subtitulo);
            imagettftext($imgPhoto, $tamanhoFontTexto3, 0, 105+$x_anuncio-10-20+$move_x, 505+$y_anuncio+$move_y, $cinza, $font, $desc);
            imagettftext($imgPhoto, 18, 0, 105+$x_anuncio-10-20+$move_x, 545+$y_anuncio+$move_y, $black, $fontBold, 'de');
            imagettftext($imgPhoto, 24, 0, 135+$x_anuncio-20+$move_x, 545+$y_anuncio+$move_y, $black, $fontBold, 'R$ '.$preco);
            imagecopymerge($imgPhoto, $imgLine, 127+$x_anuncio-20+$move_x, 536+$y_anuncio+$move_y, 0, 0, $widthPreco_+27, $constLineHeight, 100);
            imagettftext($imgPhoto, 18, 0, 105+$x_anuncio-10-20+$move_x, 565+$y_anuncio+$move_y, $black, $fontBold, 'por');
            imagettftext($imgPhoto, 26, 0, 105+$x_anuncio-10-20+$move_x, 600+$y_anuncio+$move_y, $textPromo, $fontBold, 'R$');
            imagettftext($imgPhoto, 50, 0, 140+$x_anuncio-20+$move_x, 600+$y_anuncio+$move_y, $textPromo, $fontBold, $promo);
            imagettftext($imgPhoto, 18, 0, 145+$x_anuncio+$widthPromo-20+$move_x, 615+$y_anuncio+$move_y, $black, $fontBold, 'cada');
        break;
        case "off":
            ...
            imagettftext($imgPhoto, $tamanhoFontTexto, 0, 105+$x_anuncio-10-20+$move_x, 435+$y_anuncio+$move_y, $black, $fontBold, $titulo);
            imagettftext($imgPhoto, $tamanhoFontTexto, 0, 105+$x_anuncio-10-20+$move_x, 473+$y_anuncio+$move_y, $black, $font, $subtitulo);
            imagettftext($imgPhoto, $tamanhoFontTexto3, 0, 105+$x_anuncio-10-20+$move_x, 505+$y_anuncio+$move_y, $cinza, $font, $desc);
            ...
            imagettftext($imgPhoto, 18, 0, 145+$x_anuncio+$widthPreco-20+$move_x, 615+$y_anuncio-30+$move_y, $black, $fontBold, 'cada');
        break;
    }
