...
/*                         if ($utilizacao == "postavel" || $utilizacao == "sem_restricao"){
                        ...
                        if($utilizacao == "download" || $utilizacao == "sem_restricao"){
                            echo '
                                ...
                                <div id="print-page" class="buttons-tool button-form" blocked-evt="false">
                                    <img src="'.$__HTTP_HOST.'/images/print.png"/>
                                    <div class="buttons-tool-text">Imprimir</div>
                                </div>
                            ';
                        }
                    }
 ...
 */
                ...
                echo '
                    ...
                    <div id="print-all-list" class="buttons-tool button-list">
                        <img src="'.$__HTTP_HOST.'/images/print.png"/>
                        <div class="buttons-tool-text">Imprimir</div>
                    </div>
